                                ...
                                <table width="50%">
                                    <tr>
                                        ...
                                        <td width="40%"><h:inputText id="username" value="#{loginPro.username}" 
                                                     ...
                                                     validatorMessage="The length should be from 4 to 20">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <h:commandButton value="Login" action="#{loginPro.execute}"/></td>
                                    </tr>
                                </table>
                            </h:form>
                            <img id="d" src="authImg.jpg" alt="validation code image"/>
                        </div>
                    </td>
                </tr>
            </table>
