...
<tr>
	<td width="116"><a href="viewSuccess.jsp">查看竞得的物品</a></td>
	<td width="101"><a href="viewFail.jsp">浏览流拍物品</a></td>
	<td width="79"><a href="mgrKind.jsp">管理种类</a></td>
	<td width="79"><a href="mgrItem.jsp">管理物品</a></td>
	<td width="105"><a href="viewKind.jsp">浏览拍卖物品</a></td>
	<td width="110"><a href="viewBid.jsp">查看自己的竞标</a></td>
	<td width="70"><a href="main.jsp" >返回首页</a></div></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td><b><Powered By</b><img src="images/jboss.gif" width="188" height="66"></td>
</tr>
</table>
</td>
</tr>
...
如有任何问题和建议，请登录<a href="http://www.crazyit.org">疯狂Java联盟</a>反映！</p>
</div></td>
</tr>
